<template>
  <div class="bg white ph15" style="min-height: 100vh">
    <header class="mui-bar mui-bar-nav top-bar bg maincolor noshadow">
      ...
      <h1 class="mui-title color white">找回密码</h1>
    </header>
    <div class="mui-content bg white">
      ...
      <div class="btn-block btn-maincolor mv20" style="margin-bottom: 10px !important;" @tap="reset">重置密码</div>
    </div>
  </div>
</template>

<script>
import {resetPassword, sendCode} from 'ajax'
